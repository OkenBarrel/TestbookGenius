...
class Book(models.Model):
    ...
    isbn = models.CharField(
        max_length=13, null=False, default="0000000000", unique=True, primary_key=True
    )
...
class Teacher(models.Model):
    ...
    teacher_name = models.CharField(
        max_length=50, null=False, default="", db_index=True
    )
...
class Profile(models.Model):
    ...
    user_avatar = models.ImageField(
        upload_to="Avatar/", null=False, blank=True, default="Avatar/DefaultAvatar.png"
    )
...
class Comment(models.Model):
    ...
    usebook = models.ForeignKey(
        Usebook, on_delete=models.CASCADE, db_index=True
    )  # on_update=models.CASCADE
